...
profile2 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/donnie.png")
profile3 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/polly.png")
profile4 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/andy.png")
profile5 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/trevor.png")
profile6 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/ivo.png")
profile7 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/anis.png")
profile8 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/daniel.png")
profile9 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/jon.png")
profile10 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/jesse.png")
profile11 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/allen.png")


user2.image.attach(io: profile2, filename: "donnie.png")
user3.image.attach(io: profile3, filename: "polly.png")
user4.image.attach(io: profile4, filename: "andy.png")
user5.image.attach(io: profile5, filename: "trevor.png")
user6.image.attach(io: profile6, filename: "ivo.png")
user7.image.attach(io: profile7, filename: "anis.png")
user8.image.attach(io: profile8, filename: "daniel.png")
user9.image.attach(io: profile9, filename: "jon.png")
user10.image.attach(io: profile10, filename: "jesse.png")
user11.image.attach(io: profile11, filename: "allen.png")
...
playlist1 = Playlist.create!(title: "Weird Jams", user_id: user2.id, song_ids: [song1.id, song4.id, song7.id, song9.id])
playlist2 = Playlist.create!(title: "Summertime Sad-Songs", user_id: user6.id, song_ids: [song2.id, song5.id, song8.id, song10.id])
playlist3 = Playlist.create!(title: "Shoutin at the Sun", user_id: user2.id, song_ids: [song3.id, song6.id, song9.id, song11.id])
playlist4 = Playlist.create!(title: "Mellow Yellow Donovan Tribute", user_id: user7.id, song_ids: [song4.id, song9.id, song12.id, song15.id])
playlist5 = Playlist.create!(title: "They Might Be Giant....Hits!!", user_id: user2.id, song_ids: [song16.id, song13.id, song1.id, song5.id])
playlist6 = Playlist.create!(title: "Vaudevillian Discotheque Villains", user_id: user3.id, song_ids: [song14.id, song2.id, song3.id, song10.id])
playlist7 = Playlist.create!(title: "Noir Pop", user_id: user3.id, song_ids: [song7.id, song4.id, song5.id, song9.id])
playlist8 = Playlist.create!(title: "Anger Management Classical Music", user_id: user4.id, song_ids: [song8.id, song6.id, song11.id, song12.id])
playlist9 = Playlist.create!(title: "Popular Mechanics for Math Rock Enthusiasts", user_id: user4.id, song_ids: [song13.id, song9.id, song4.id, song10.id])
playlist10 = Playlist.create!(title: "Martha Stewart's Favorites", user_id: user5.id, song_ids: [song2.id, song12.id, song6.id])
playlist11 = Playlist.create!(title: "The Rutles Greatest Hits", user_id: user6.id, song_ids: [song7.id, song8.id, song14.id])
playlist12 = Playlist.create!(title: "Dry Roasted Vince Guaraldi Sleepers", user_id: user6.id, song_ids: [song6.id, song3.id, song14.id, song9.id])

jpg17 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/weirdJams.png")
jpg18 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/summertimeSadSong.png")
jpg19 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/shoutinAtTheSun.png")
jpg20 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/donovanTribute.png")
jpg21 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/tmbgHits.png")
jpg22 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/vaudvillianDisco.png")
jpg23 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/noirPop.png")
jpg24 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/angerManagement.png")
jpg25 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/popularMechanics.png")
jpg26 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/marthaStewart.png")
jpg27 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/theRutles.png")
jpg28 = open("https://donnie-loudcloud-prod.s3.us-east-2.amazonaws.com/dryRoasted.png")

playlist1.image.attach(io: jpg17, filename:"weird.png")
playlist2.image.attach(io: jpg18, filename:"sad.png")
playlist3.image.attach(io: jpg19, filename:"sun.png")
playlist4.image.attach(io: jpg20, filename:"donovan.png")
playlist5.image.attach(io: jpg21, filename:"tmbg.png")
playlist6.image.attach(io: jpg22, filename:"disco.png")
playlist7.image.attach(io: jpg23, filename:"noirPop.png")
playlist8.image.attach(io: jpg24, filename:"anger.png")
playlist9.image.attach(io: jpg25, filename:"popular.png")
playlist10.image.attach(io: jpg26, filename:"martha.png")
playlist11.image.attach(io: jpg27, filename:"rutles.png")
playlist12.image.attach(io: jpg28, filename:"dryRoasted.png")